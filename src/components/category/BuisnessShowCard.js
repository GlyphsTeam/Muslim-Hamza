...
function BuisnessShowCard({limit, mainidC,categoryData, previousPage, nextPage, total, setActiveIndex, activeIndex, page, setPage, scrollPagination,categoryState, setCategoryState}) {
...
export default BuisnessShowCard