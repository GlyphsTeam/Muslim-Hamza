...
import style from "../../assets/style/legal/legalPageStyle.module.css";

function Terms_conditions() {
  const projectTitle = process.env.REACT_APP_legalProjectTitle;
  const projectEmail = process.env.REACT_APP_legalProjectEmail;
  
  return (
    <div className={`container mt-2 px-3 mb-5 ${style.legalDiv} `}>
      <h2 className={`${style.termConditionTitle}`}>Terms & Conditions</h2>
      <p>
        ...
        other intellectual property rights related to it, still belong to Glyphs
        Marketing.
      </p>
      <p>
        Glyphs Marketing is committed to ensuring that the app is as useful and
      ...
      <p>
        The {projectTitle} Community app stores and processes personal data that
        ...
        phone’s security features and it could mean that the {projectTitle}
        Community app won’t work properly or at all.
      </p>
      <p>
      ...
      <ul className={style.list}>
        ...
        <li>
          <a href="https://www.facebook.com/legal/terms/plain_text_terms">
            * Facebook
          </a>
        </li>
        <li>
      ...
      <p>
        You should be aware that there are certain things that Glyphs Marketing
        ...
        can be Wi-Fi or provided by your mobile network provider, but Glyphs
        Marketing cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Glyphs Marketing cannot always take responsibility
        ...
        avail the Service, Glyphs Marketing cannot accept responsibility.
      </p>
      <p>
        With respect to Glyphs Marketing ’s responsibility for your use of the
        ...
        we can make it available to you. Glyphs Marketing accepts no liability
      ...
      <p>
        ...
        to keep using the app. Glyphs Marketing does not promise that it will
      ...
      <p>These terms and conditions are effective as of 2023-03-08</p>
      <p>Contact Us</p>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at {projectEmail}.
      </p>

      <div className="mt-4">
        <Link to="/Privacy-policy" className={`${style.termsBtn}`}>
          Show privacy policy
        </Link>
      </div>
    </div>
